...
import { TokenStorageService } from './user-app/core/services/token-storege.services';
        ...
        <div class="layout-topbar">
            <div class="layout-topbar-wrapper">
                <div class="layout-topbar-left">
                    <div class="layout-topbar-logo" id="logolink" style="cursor: pointer; outline: none;" routerLink="/user">
<!--                         <img id="app-logo"
                             [src]="'assets/layout/images/logo-' + (app.topbarTheme === 'light' ? 'poseidon' : 'poseidon-dark') + '.png'"
                             alt="poseidon-layout"> -->
                             <h3 style="margin-top: 15px;"><i class="pi pi-user" style="font-size: 2rem"></i>  User List</h3>
                    </div>
                </div>
                ...
                <div class="layout-topbar-right">
                    ...
                    <ul class="layout-topbar-actions">
                        <p-button routerLink="/login" (click)="clearLocalStorage()">
                            Logout
                        </p-button>
...
export class AppTopBarComponent {
    ...
    constructor(public appMain: AppMainComponent, public app: AppComponent, public tokeStorage: TokenStorageService) {
    }
